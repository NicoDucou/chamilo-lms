...
final class Version20251202103000 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE access_url CHANGE email email varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE block CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE block CHANGE path path varchar(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE block CHANGE title title varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE branch_sync CHANGE admin_mail admin_mail varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE admin_name admin_name varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE admin_phone admin_phone varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE branch_ip branch_ip varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE branch_type branch_type varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE last_sync_type last_sync_type varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE ssl_pub_key ssl_pub_key varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE branch_transaction CHANGE action action varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_transaction CHANGE dest_id dest_id varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_transaction CHANGE external_info external_info varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_transaction CHANGE item_id item_id varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_transaction CHANGE origin origin varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course CHANGE department_name department_name varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE department_url department_url varchar(180) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE directory directory varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE introduction introduction longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE legal legal longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE registration_code registration_code varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE title title varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE tutor_name tutor_name varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course CHANGE visual_code visual_code varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_category CHANGE auth_cat_child auth_cat_child varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course_category CHANGE auth_course_child auth_course_child varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_category CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_request CHANGE category_code category_code varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_request CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course_request CHANGE objetives objetives longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course_request CHANGE target_audience target_audience longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_request CHANGE tutor_name tutor_name varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course_request CHANGE visual_code visual_code varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_type CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course_type CHANGE props props longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_type CHANGE translation_var translation_var varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_announcement_attachment CHANGE comment comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_attendance CHANGE attendance_qualify_title attendance_qualify_title varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_attendance CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_attendance_sheet CHANGE signature signature longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_blog CHANGE blog_subtitle blog_subtitle varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_blog_attachment CHANGE comment comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_blog_task CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_calendar_event CHANGE color color varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_calendar_event CHANGE comment comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_calendar_event CHANGE content content longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_calendar_event CHANGE invitation_type invitation_type varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_calendar_event_attachment CHANGE comment comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_calendar_event_repeat CHANGE cal_days cal_days varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_calendar_event_repeat CHANGE cal_type cal_type varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_course_description CHANGE content content longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_course_description CHANGE title title longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_course_setting CHANGE category category varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_course_setting CHANGE comment comment varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_course_setting CHANGE subkey subkey varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_course_setting CHANGE subkeytext subkeytext varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_course_setting CHANGE type type varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_course_setting CHANGE value value longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_document CHANGE comment comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_dropbox_post CHANGE feedback feedback longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_attachment CHANGE comment comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_category CHANGE cat_comment cat_comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_forum CHANGE approval_direct_post approval_direct_post varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_forum_forum CHANGE default_view default_view varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_forum_forum CHANGE forum_comment forum_comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_forum_forum CHANGE forum_group_public_private forum_group_public_private varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_forum CHANGE forum_of_group forum_of_group varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_post CHANGE post_text post_text longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_thread CHANGE thread_title_qualify thread_title_qualify varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_group_category CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_group_info CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_link CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_link CHANGE target target varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_link_category CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp CHANGE ref ref longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp_item CHANGE audio audio varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE description description varchar(511) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp_item CHANGE max_time_allowed max_time_allowed varchar(13) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE parameters parameters longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE path path longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE prerequisite prerequisite longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE ref ref longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE terms terms longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp_item_view CHANGE lesson_location lesson_location longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item_view CHANGE max_score max_score varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp_item_view CHANGE suspend_data suspend_data longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz CHANGE access_condition access_condition longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz CHANGE notifications notifications varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz CHANGE sound sound varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz CHANGE text_when_finished text_when_finished longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz CHANGE text_when_finished_failure text_when_finished_failure longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz_answer CHANGE answer_code answer_code varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_answer CHANGE comment comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_answer CHANGE hotspot_coordinates hotspot_coordinates longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_answer CHANGE hotspot_type hotspot_type varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
	// Change collation for c_quiz_category table
        ...
        $this->addSql('ALTER TABLE c_quiz_category CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz_question CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_question CHANGE extra extra varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_question CHANGE feedback feedback longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_question CHANGE picture picture varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz_question CHANGE question_code question_code varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz_question_category CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz_rel_question CHANGE destination destination longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_student_publication CHANGE author author varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_student_publication CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_student_publication CHANGE extensions extensions longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_student_publication_comment CHANGE comment comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_student_publication_comment CHANGE file file varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE access_condition access_condition longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE code code varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE intro intro longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE is_shared is_shared varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_survey CHANGE lang lang varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE subtitle subtitle longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_survey CHANGE surveythanks surveythanks longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE template template varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_thematic CHANGE content content longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_thematic_advance CHANGE content content longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_thematic_plan CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_wiki_discuss CHANGE p_score p_score varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE extra_field CHANGE default_value default_value longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field CHANGE display_text display_text varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field CHANGE helper_text helper_text longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE extra_field_options CHANGE display_text display_text varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field_options CHANGE option_value option_value longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field_options CHANGE priority priority varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field_options CHANGE priority_message priority_message varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE extra_field_saved_search CHANGE value value longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE extra_field_values CHANGE comment comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field_values CHANGE field_value field_value longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE ext_log_entries CHANGE data data longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE ext_log_entries CHANGE object_id object_id varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE ext_log_entries CHANGE username username varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_category CHANGE depends depends longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE gradebook_category CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_certificate CHANGE path_certificate path_certificate longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_evaluation CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_evaluation CHANGE user_score_list user_score_list longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_link CHANGE user_score_list user_score_list longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_linkeval_log CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE grade_model CHANGE default_external_eval_prefix default_external_eval_prefix varchar(140) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE grade_model CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE language CHANGE original_name original_name varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE legal CHANGE content content longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE message_attachment CHANGE comment comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE portfolio_category CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE room CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE room CHANGE geolocation geolocation varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE room CHANGE ip ip varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE room CHANGE ip_mask ip_mask varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE sequence CHANGE graph graph longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE sequence_variable CHANGE default_val default_val varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE sequence_variable CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE sequence_variable CHANGE title title varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE session CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE settings CHANGE category category varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE comment comment longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE scope scope varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE selected_value selected_value longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE subkey subkey varchar(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE subkeytext subkeytext varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE title title longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE type type varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE settings_options CHANGE value value varchar(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE skill CHANGE criteria criteria longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE skill_rel_item CHANGE obtain_conditions obtain_conditions varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE system_template CHANGE language language varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE sys_announcement CHANGE lang lang varchar(70) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE ticket_category CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE ticket_priority CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE ticket_status CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE track_e_access CHANGE access_tool access_tool varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE track_e_attempt CHANGE filename filename varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE track_e_downloads CHANGE down_doc_path down_doc_path varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE track_e_exercises CHANGE blocked_categories blocked_categories longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE track_e_lastaccess CHANGE access_tool access_tool varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE address address varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE api_token api_token varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE biography biography longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE competences competences longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE confirmation_token confirmation_token varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE diplomas diplomas longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE firstname firstname varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE gender gender varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE lastname lastname varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE locale locale varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE mfa_backup_codes mfa_backup_codes longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE mfa_secret mfa_secret varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE mfa_service mfa_service varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE official_code official_code varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE openarea openarea longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE openid openid varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE phone phone varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE picture_uri picture_uri varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE productions productions varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE teach teach longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE theme theme varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE website website varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE usergroup CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE usergroup CHANGE picture picture varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE usergroup CHANGE url url varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user_api_key CHANGE api_end_point api_end_point longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user_api_key CHANGE description description longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        ...
        // Change collation for version table
        $this->addSql('ALTER TABLE version CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE version CHANGE version version varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE access_url CHANGE email email varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE block CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE block CHANGE path path varchar(190) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE block CHANGE title title varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE branch_sync CHANGE admin_mail admin_mail varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE admin_name admin_name varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE admin_phone admin_phone varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE branch_ip branch_ip varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE branch_type branch_type varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE last_sync_type last_sync_type varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_sync CHANGE ssl_pub_key ssl_pub_key varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE branch_transaction CHANGE action action varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_transaction CHANGE dest_id dest_id varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_transaction CHANGE external_info external_info varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_transaction CHANGE item_id item_id varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE branch_transaction CHANGE origin origin varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course CHANGE department_name department_name varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE department_url department_url varchar(180) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE directory directory varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE introduction introduction longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE legal legal longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE registration_code registration_code varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE title title varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course CHANGE tutor_name tutor_name varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course CHANGE visual_code visual_code varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_category CHANGE auth_cat_child auth_cat_child varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course_category CHANGE auth_course_child auth_course_child varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_category CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_request CHANGE category_code category_code varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_request CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course_request CHANGE objetives objetives longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course_request CHANGE target_audience target_audience longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_request CHANGE tutor_name tutor_name varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course_request CHANGE visual_code visual_code varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_type CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE course_type CHANGE props props longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE course_type CHANGE translation_var translation_var varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_announcement_attachment CHANGE comment comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_attendance CHANGE attendance_qualify_title attendance_qualify_title varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_attendance CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_attendance_sheet CHANGE signature signature longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_blog CHANGE blog_subtitle blog_subtitle varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_blog_attachment CHANGE comment comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_blog_task CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_calendar_event CHANGE color color varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_calendar_event CHANGE comment comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_calendar_event CHANGE content content longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_calendar_event CHANGE invitation_type invitation_type varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_calendar_event_attachment CHANGE comment comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_calendar_event_repeat CHANGE cal_days cal_days varchar(7) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_calendar_event_repeat CHANGE cal_type cal_type varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_course_description CHANGE content content longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_course_description CHANGE title title longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_course_setting CHANGE category category varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_course_setting CHANGE comment comment varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_course_setting CHANGE subkey subkey varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_course_setting CHANGE subkeytext subkeytext varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_course_setting CHANGE type type varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_course_setting CHANGE value value longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_document CHANGE comment comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_dropbox_post CHANGE feedback feedback longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_attachment CHANGE comment comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_category CHANGE cat_comment cat_comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_forum CHANGE approval_direct_post approval_direct_post varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_forum_forum CHANGE default_view default_view varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_forum_forum CHANGE forum_comment forum_comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_forum_forum CHANGE forum_group_public_private forum_group_public_private varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_forum CHANGE forum_of_group forum_of_group varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_post CHANGE post_text post_text longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_forum_thread CHANGE thread_title_qualify thread_title_qualify varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_group_category CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_group_info CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_link CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_link CHANGE target target varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_link_category CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp CHANGE ref ref longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp_item CHANGE audio audio varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE description description varchar(511) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp_item CHANGE max_time_allowed max_time_allowed varchar(13) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE parameters parameters longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE path path longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE prerequisite prerequisite longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE ref ref longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item CHANGE terms terms longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp_item_view CHANGE lesson_location lesson_location longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_lp_item_view CHANGE max_score max_score varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_lp_item_view CHANGE suspend_data suspend_data longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz CHANGE access_condition access_condition longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz CHANGE notifications notifications varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz CHANGE sound sound varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz CHANGE text_when_finished text_when_finished longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz CHANGE text_when_finished_failure text_when_finished_failure longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz_answer CHANGE answer_code answer_code varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_answer CHANGE comment comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_answer CHANGE hotspot_coordinates hotspot_coordinates longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_answer CHANGE hotspot_type hotspot_type varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
	// Revert collation for c_quiz_category table
        ...
        $this->addSql('ALTER TABLE c_quiz_category CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz_question CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_question CHANGE extra extra varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_question CHANGE feedback feedback longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_quiz_question CHANGE picture picture varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz_question CHANGE question_code question_code varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz_question_category CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_quiz_rel_question CHANGE destination destination longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_student_publication CHANGE author author varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_student_publication CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_student_publication CHANGE extensions extensions longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_student_publication_comment CHANGE comment comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_student_publication_comment CHANGE file file varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE access_condition access_condition longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE code code varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE intro intro longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE is_shared is_shared varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_survey CHANGE lang lang varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE subtitle subtitle longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE c_survey CHANGE surveythanks surveythanks longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_survey CHANGE template template varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_thematic CHANGE content content longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_thematic_advance CHANGE content content longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_thematic_plan CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE c_wiki_discuss CHANGE p_score p_score varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE extra_field CHANGE default_value default_value longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field CHANGE display_text display_text varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field CHANGE helper_text helper_text longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE extra_field_options CHANGE display_text display_text varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field_options CHANGE option_value option_value longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field_options CHANGE priority priority varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field_options CHANGE priority_message priority_message varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE extra_field_saved_search CHANGE value value longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE extra_field_values CHANGE comment comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE extra_field_values CHANGE field_value field_value longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE ext_log_entries CHANGE data data longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE ext_log_entries CHANGE object_id object_id varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE ext_log_entries CHANGE username username varchar(191) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_category CHANGE depends depends longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE gradebook_category CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_certificate CHANGE path_certificate path_certificate longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_evaluation CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_evaluation CHANGE user_score_list user_score_list longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_link CHANGE user_score_list user_score_list longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE gradebook_linkeval_log CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE grade_model CHANGE default_external_eval_prefix default_external_eval_prefix varchar(140) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE grade_model CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE language CHANGE original_name original_name varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE legal CHANGE content content longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE message_attachment CHANGE comment comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE portfolio_category CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE room CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE room CHANGE geolocation geolocation varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE room CHANGE ip ip varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE room CHANGE ip_mask ip_mask varchar(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE sequence CHANGE graph graph longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE sequence_variable CHANGE default_val default_val varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE sequence_variable CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE sequence_variable CHANGE title title varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE session CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE settings CHANGE category category varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE comment comment longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE scope scope varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE selected_value selected_value longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE subkey subkey varchar(190) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE subkeytext subkeytext varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE title title longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE settings CHANGE type type varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE settings_options CHANGE value value varchar(190) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE skill CHANGE criteria criteria longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE skill_rel_item CHANGE obtain_conditions obtain_conditions varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE system_template CHANGE language language varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE sys_announcement CHANGE lang lang varchar(70) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE ticket_category CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE ticket_priority CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE ticket_status CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE track_e_access CHANGE access_tool access_tool varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE track_e_attempt CHANGE filename filename varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE track_e_downloads CHANGE down_doc_path down_doc_path varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE track_e_exercises CHANGE blocked_categories blocked_categories longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE track_e_lastaccess CHANGE access_tool access_tool varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE address address varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE api_token api_token varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE biography biography longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE competences competences longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE confirmation_token confirmation_token varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE diplomas diplomas longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE firstname firstname varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE gender gender varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE lastname lastname varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE locale locale varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE mfa_backup_codes mfa_backup_codes longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE mfa_secret mfa_secret varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE mfa_service mfa_service varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE official_code official_code varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE openarea openarea longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE openid openid varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE phone phone varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE picture_uri picture_uri varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE productions productions varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE teach teach longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE theme theme varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE website website varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE usergroup CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        $this->addSql('ALTER TABLE usergroup CHANGE picture picture varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE usergroup CHANGE url url varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user_api_key CHANGE api_end_point api_end_point longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        $this->addSql('ALTER TABLE user_api_key CHANGE description description longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
        ...
        // Revert collation for version table
        $this->addSql('ALTER TABLE version CONVERT TO CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci');
        $this->addSql('ALTER TABLE version CHANGE version version varchar(1024) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL');
